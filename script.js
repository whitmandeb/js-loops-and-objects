...
console.log("My name is " + person.name + " and I am " + person.age + " years old. My favorite color is " + person.favColor + ".");
...
for (i=0; i < books.length; i++){
    currentBook = books[i];
    console.log(currentBook.title + " by " + currentBook.author + " - " + currentBook.pages + " pages.");
};
...
function describePerson(obj){
    console.log(obj.name + " is " + obj.age + " years old and " + obj.favColor + " is their favorite color.");
};
